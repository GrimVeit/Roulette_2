...
public class Tutorial_01_MonicaAgainState_AmericaMulti : IState
{
    ...
    public Tutorial_01_MonicaAgainState_AmericaMulti(IGlobalStateMachineProvider stateMachine, DialoguePresenter dialoguePresenter, IBetCellActivatorProvider betCellActivatorProvider, IPseudoChipActivatorProvider pseudoChipActivatorProvider, UIGameSceneRoot_Game sceneRoot)
    {
    ...
    {
        Debug.Log("<color=red>ACTIVATE STATE - TUTORIAL 01 STATE / AMERICA MULTI</color>");
    ...
    {
        _stateMachine.SetState(_stateMachine.GetState<Tutorial_02_MaryCatchState_AmericaMulti>());
    }
}
