...
public class MainState_AmericaTracker : IState
{
    ...
    public MainState_AmericaTracker(IGlobalStateMachineProvider stateProvider, UIGameSceneRoot_Game sceneRoot, BetPresenter betPresenter, IBetCellActivatorProvider betCellActivatorProvider, IPseudoChipActivatorProvider pseudoChipActivatorProvider)
    {
    ...
    {
        _stateProvider.SetState(_stateProvider.GetState<RouletteState_AmericaTracker>());
    }
}
