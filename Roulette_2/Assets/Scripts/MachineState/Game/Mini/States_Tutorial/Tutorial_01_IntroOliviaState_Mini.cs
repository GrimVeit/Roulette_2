...
public class Tutorial_01_IntroOliviaState_Mini : IState
{
    ...
    public Tutorial_01_IntroOliviaState_Mini(IGlobalStateMachineProvider stateMachine, DialoguePresenter dialoguePresenter, IBetCellActivatorProvider betCellActivatorProvider, IPseudoChipActivatorProvider pseudoChipActivatorProvider)
    {
    ...
    {
        Debug.Log("<color=red>ACTIVATE STATE - TUTORIAL 01 STATE / MINI</color>");
    ...
    {
        _stateMachine.SetState(_stateMachine.GetState<Tutorial_02_IntroMonicaState_Mini>());
    }
}
