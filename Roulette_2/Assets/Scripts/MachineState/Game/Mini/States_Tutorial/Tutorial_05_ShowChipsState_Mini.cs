...
public class Tutorial_05_ShowChipsState_Mini : IState
{
    ...
    {
        Debug.Log("<color=red>ACTIVATE STATE - TUTORIAL 05 STATE / MINI</color>");
    ...
    {
        _stateMachine.SetState(_stateMachine.GetState<Tutorial_06_ExplainChipPlaceState_Mini>());
    }
}
