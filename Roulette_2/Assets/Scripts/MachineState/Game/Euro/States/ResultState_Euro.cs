...
public class ResultState_Euro : IState
{
    ...
    public ResultState_Euro(IGlobalStateMachineProvider machineProvider, UIGameSceneRoot_Game sceneRoot, BetPresenter betPresenter, IAnimationFrameProvider frameProvider)
    {
