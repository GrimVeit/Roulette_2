...
public class Tutorial_07_DailyBonus2State_Menu : IState
{
    ...
    public Tutorial_07_DailyBonus2State_Menu(IGlobalStateMachineProvider globalStateMachineProvider, DialoguePresenter dialoguePresenter, UIMainMenuRoot sceneRoot)
    {
