...
public class GameSceneEntryPoint_AmericaTracker : MonoBehaviour
{
    ...
    public void Run(UIRootView uIRootView)
    {
        ...
        stateMachine = new StateMachine_AmericaTracker(sceneRoot, rouletteBallPresenter, roulettePresenter, rouletteValueHistoryPresenter, betPresenter, metric_GameCountPresenter, metric_GameTypeCountPresenter, animationFramePresenter);
